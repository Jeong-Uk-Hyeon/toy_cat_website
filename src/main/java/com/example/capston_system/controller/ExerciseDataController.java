...
public class ExerciseDataController {
    ...
    // ================== [수정됨] 범위에 따른 운동량 요청 =====================
    // 프론트엔드: GET /api/exercise/period?startDate=2025-06-01&endDate=2025-06-07
    @GetMapping("/period")
    public List<ExerciseData> getByPeriod(
            // Spring이 "2025-06-01" 문자열을 자동으로 LocalDate 객체로 변환해 줍니다.
            @RequestParam LocalDate startDate,
            @RequestParam LocalDate endDate
    ) {
        // 기존 서비스의 범위 조회 메서드를 그대로 사용합니다.
